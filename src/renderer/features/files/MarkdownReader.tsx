...
function mermaidThemeVariables(): Record<string, string> {
  ...
  return {
    ...
    primaryColor: token('--color-surface-raised', '#1c1c1c'),
    primaryTextColor: token('--color-text-primary', '#ededed'),
    primaryBorderColor: token('--color-border-default', '#2e2e2e'),
    secondaryColor: token('--color-surface-sunken', '#101010'),
    tertiaryColor: token('--color-surface-hover', '#202020'),
    lineColor: token('--color-border-strong', '#3a3a3a'),
    textColor: token('--color-text-primary', '#ededed'),
    mainBkg: token('--color-surface-raised', '#1c1c1c'),
    nodeBorder: token('--color-border-default', '#2e2e2e'),
    clusterBkg: token('--color-surface-sunken', '#101010'),
    titleColor: token('--color-text-primary', '#ededed'),
    edgeLabelBackground: token('--color-surface-overlay', '#222222'),
