...
function mermaidThemeVariables(): Record<string, string> {
  ...
  return {
    ...
    background: token('--color-surface-canvas', '#141414'),
    primaryColor: token('--color-surface-raised', '#262626'),
    primaryTextColor: token('--color-text-primary', '#f0f0f0'),
    primaryBorderColor: token('--color-border-default', 'rgba(240,240,240,0.15)'),
    secondaryColor: token('--color-surface-sunken', '#141414'),
    tertiaryColor: token('--color-surface-hover', 'rgba(240,240,240,0.067)'),
    lineColor: token('--color-border-strong', '#343434'),
    textColor: token('--color-text-primary', '#f0f0f0'),
    mainBkg: token('--color-surface-raised', '#262626'),
    nodeBorder: token('--color-border-default', 'rgba(240,240,240,0.15)'),
    clusterBkg: token('--color-surface-sunken', '#141414'),
    titleColor: token('--color-text-primary', '#f0f0f0'),
    edgeLabelBackground: token('--color-surface-overlay', '#141414'),
